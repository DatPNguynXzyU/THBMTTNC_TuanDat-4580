...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # Connect buttons using the default names from the UI file
    ...
    def call_api_encrypt(self):
        ...
        payload = {
            ...
            "key": self.ui.textEdit_2.toPlainText()  # Changed to toPlainText()
        }
        try:
            ...
            print("Error: %s" % str(e))  # Fixed Python 3 exception printing
